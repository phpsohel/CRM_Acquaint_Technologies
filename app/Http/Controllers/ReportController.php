    ...
    public function leadStatusReport(Request $request)
{
    ...
    public function getleadReminderReport(Request $request)
    {
        ...
        if ($stage == 2 &&  $user_id == 0 ){
            ...
            $lims_reminder_data = Remainder::where('employee_id',$user_id)->whereDate('noti_datetime', '>=' , $start_date)->whereDate('noti_datetime', '<=' , $end_date)->where('status', true)->get();
        }elseif($user_id == 0){
            ...
            $lims_reminder_data = Remainder::where('stage',$stage)->where('employee_id',$user_id)->whereDate('noti_datetime', '>=' , $start_date)->whereDate('noti_datetime', '<=' , $end_date)->where('status', true)->get();
        }
