            ...
            <div class="main-menu">
                ...
                ?>
                    ...
                    <li class=""><a href="#project" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-box"></i><span>Project</span></a>
                        <ul id="project" class="collapse list-unstyled ">
                            ...
                            {{--<li id="employee-menu"><a href="{{route('lead_remainder.index')}}">Lead Remainder</a>
                    </li>--}}
                ...
                <li class=""><a href="#ticket" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-ticket"></i><span>Ticket</span></a>
                    <ul id="ticket" class="collapse list-unstyled ">
                        ...
                        {{--<li id="employee-menu"><a href="{{route('ticket_replies.index')}}">Ticket Replies</a>
                </li>--}}
                ...
                <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document-remove"></i><span>{{trans('file.Reports')}}</span></a>
                    <ul id="report" class="collapse list-unstyled ">
                        ...
                        <li id="lead_employee-report-menu">
                            <a id="lead_employee-report-link" href="{{ route('report.getlead_employee') }}">Lead Category Report</a>
                        </li>

                        <li id="lead_source-report-menu">
                            <a id="lead_source-report-link" href="{{ route('report.getlead_source') }}">Lead source Report</a>
                        </li>

                        <li id="lead_status-report-menu">
                            <a id="lead_status-report-link" href="{{ route('report.getlead_status') }}">Lead Status Report</a>
                        </li>


                        <li id="lead_reminder-report-menu">
                            <a id="lead_reminder-report-link" href="{{ route('report.getlead_reminder_report') }}">Lead Reminder Report</a>
                        </li>
                        ...
                        <li id="sale-report-menu">
                            <a id="sale-report-link" href="{{ route('report.getsale') }}">{{trans('file.Sale Report')}}</a>
                        </li>
                        @endif

                        @if($payment_report_active)
                        <li id="payment-report-menu">
                            <a id="payment-report-link" href="{{ route('report.getpaymentByDate') }}">{{trans('file.Payment Report')}}</a>
                        </li>
                        @endif
                        ...
                        <li id="due-report-menu">
                            <a id="due-report-link" href="{{ route('report.getdueByDate') }}">{{trans('file.Due Report')}}</a>
                        </li>
                        @endif
                    </ul>
                </li>
...
//                        ['role_id', $role->id] ])->first();
              ...
              ?>
                ...
                <li id="unit-menu"><a href="{{route('thana.index')}}">Thana</a></li>
                @endif
            ...
            <div class="container-fluid">
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <span class="brand-big" style="left:12%;">@if($general_setting->site_logo)<img src="{{url('public/logo', $general_setting->site_logo)}}" width="150">&nbsp;&nbsp;@endif<a href="{{url('/')}}">
                            <h1 class="d-inline" style="display:none !important;">{{$general_setting->site_title}}</h1>
                        </a></span>
