                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                @if(!empty($quotation->document))
                                @php
                                $filepath = ('public/quotation/documents/').$quotation->document;
                                 @endphp

                                <li>
                                    <a class="btn btn-link" target="_blank" href="{{ asset($filepath ?? '') }}"><i class="fa fa-shopping-basket" ></i> {{trans('View Attachment')}}</a></button>
                                </li>
                                @endif
                                <li class="divider"></li>
