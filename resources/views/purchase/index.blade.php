...
<script type="text/javascript">
    ...
    function purchaseDetails(purchase){
        ...
        $.get('purchases/product_purchase/' + purchase[3], function(data){
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=5><strong style="float:right;">{{trans("file.Total")}}:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;">{{trans("file.Order Discount")}}:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;">{{trans("file.Shipping Cost")}}:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;">{{trans("file.grand total")}}:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;">{{trans("file.Paid Amount")}}:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;">{{trans("file.Due")}}:</strong></td>';
