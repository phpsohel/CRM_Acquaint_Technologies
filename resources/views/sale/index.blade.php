    ...
    function saleDetails(sale){
        ...
        $.get('sales/product_sale/' + sale[13], function(data){
            ...
            if(sale[28]) {
                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=6><strong style="float:right;">{{trans("file.Coupon Discount")}} ['+sale[28]+']:</strong></td>';
                cols += '<td>' + sale[29] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
            }
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong style="float:right;">{{trans("file.Paid Amount")}}:</strong></td>';
            cols += '<td>' + sale[22] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong style="float:right;">{{trans("file.Due")}}:</strong></td>';
