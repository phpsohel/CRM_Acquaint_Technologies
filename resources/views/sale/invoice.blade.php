...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <p>{{trans('file.Address')}}: {{$general_setting->address}}
                <br>{{trans('file.Phone Number')}}: {{$general_setting->phone}}
            </p>
        </div>
        <p>{{trans('file.Date')}}: {{$lims_sale_data->created_at}}<br>
            {{trans('file.reference')}}: {{$lims_sale_data->reference_no}}<br>
            {{trans('file.customer')}}: {{$lims_customer_data->name}} ({{$lims_customer_data->phone_number}})<br>
            Company:{{$lims_customer_data->company_name}}
            <br>Address: {{$general_setting->address}}
        </p>
        <table>
            <tbody>
