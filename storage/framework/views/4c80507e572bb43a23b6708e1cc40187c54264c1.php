        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header mt-2">
                    <h3 class="text-center">Lead Source Report</h3>
                </div>
                <?php echo Form::open(['route' => 'report.lead_source', 'method' => 'post']); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                ...
                                <select id="lead_source_id" name="lead_source_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                    ...
                                    <?php $__currentLoopData = $lims_source_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($lead_cat->id); ?>"><?php echo e($lead_cat->source_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/report/lead_source_report.blade.php ENDPATH**/ ?>