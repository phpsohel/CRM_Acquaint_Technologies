...
<script type="text/javascript" src="<?php echo asset('public/js/front.js') ?>"></script>
  ...
  <body>
    <div class="page login-page" style="background: url(<?php echo asset('public/images/crmback.jpg') ?>); background-size: cover;">
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo">
                <span style="display:none;"><?php echo e($general_setting->site_title); ?></span>
                <img src="http://223.27.94.123:800/crm/public/logo/SomporkoLogo.png" width="55%">
            </div>
...
</script><?php /**PATH C:\laragon\www\somporko\resources\views/auth/login.blade.php ENDPATH**/ ?>