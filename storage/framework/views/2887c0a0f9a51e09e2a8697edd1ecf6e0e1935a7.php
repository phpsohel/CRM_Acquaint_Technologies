                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                <input type="hidden" name="lead_status_id_hidden" value="<?php echo e($stage); ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/report/lead_reminder_report.blade.php ENDPATH**/ ?>