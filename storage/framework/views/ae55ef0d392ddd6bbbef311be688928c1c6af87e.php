    ...
    <section class="forms">
        <div class="container-fluid">
            <div class="card">
                ...
                <?php echo Form::open(['route' => 'report.lead', 'method' => 'post']); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                <input type="hidden" name="lead_cat_id_hidden" value="<?php echo e($lead_cat_id); ?>" />
                                <select id="lead_cat_id" name="lead_cat_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                    ...
                                    <?php $__currentLoopData = $lims_lead_category_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($lead_cat->id); ?>"><?php echo e($lead_cat->lead_cat_name); ?></option>
                    ...
                    <div class="col-md-2">
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                <input type="hidden" name="lead_source_id_hidden" value="<?php echo e($lead_source_id); ?>" />
                                <select id="lead_source_id" name="lead_source_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                    ...
                                    <?php $__currentLoopData = $lims_source_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead_source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                ...
                                <select id="lead_status_id" name="lead_status_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                    ...
                                    <?php $__currentLoopData = $lims_status_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crm\resources\views/report/lead_report.blade.php ENDPATH**/ ?>