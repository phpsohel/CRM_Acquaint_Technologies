...
<div style="max-width:400px;margin:0 auto">
    ...
    <div class="hidden-print">
        <table>
            <tr>
                <td><a href="<?php echo e(route('sales.index')); ?>" class="btn btn-info"><i class="fa fa-arrow-left"></i> <?php echo e(trans('file.Back')); ?></a> </td>
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <p><?php echo e(trans('file.Address')); ?>: <?php echo e($general_setting->address); ?>

                <br><?php echo e(trans('file.Phone Number')); ?>: <?php echo e($general_setting->phone); ?>
        ...
        <p><?php echo e(trans('file.Date')); ?>: <?php echo e($lims_sale_data->created_at); ?><br>
            ...
            <?php echo e(trans('file.customer')); ?>: <?php echo e($lims_customer_data->name); ?> (<?php echo e($lims_customer_data->phone_number); ?>)<br>
            Company:<?php echo e($lims_customer_data->company_name); ?>

            <br>Address: <?php echo e($general_setting->address); ?>
...
<?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/sale/invoice.blade.php ENDPATH**/ ?>