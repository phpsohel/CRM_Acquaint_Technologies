                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label>Lead </label>
                                        <select required  name="lead_id" class="form-control" data-live-search="true" title="Select Lead Person">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\somporko\resources\views/remainder/create.blade.php ENDPATH**/ ?>