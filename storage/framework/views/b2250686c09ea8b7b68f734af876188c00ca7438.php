...
<script type="text/javascript" src="<?php echo asset('public/js/front.js') ?>"></script>
  ...
  <body>
    <div class="page login-page" style="background: url(<?php echo asset('public/images/crm_background_image.jpg') ?>); background-size: cover;">
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo">
                <span style="display:none;"><?php echo e($general_setting->site_title); ?></span>
                <img src="<?php echo e(asset('public/logo/SomporkoLogo.png')); ?>" width="55%">
            </div>
...
</script><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/auth/login.blade.php ENDPATH**/ ?>