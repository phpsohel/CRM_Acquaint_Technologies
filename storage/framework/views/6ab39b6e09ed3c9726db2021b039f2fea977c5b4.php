...
<script type="text/javascript">
    ...
    function purchaseDetails(purchase){
        ...
        $.get('purchases/product_purchase/' + purchase[3], function(data){
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=5><strong style="float:right;"><?php echo e(trans("file.Total")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;">Tax' + '(' + purchase[17] + '%)' +':</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;"><?php echo e(trans("file.Order Discount")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;"><?php echo e(trans("file.Shipping Cost")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;"><?php echo e(trans("file.grand total")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;"><?php echo e(trans("file.Paid Amount")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7><strong style="float:right;"><?php echo e(trans("file.Due")); ?>:</strong></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/purchase/index.blade.php ENDPATH**/ ?>