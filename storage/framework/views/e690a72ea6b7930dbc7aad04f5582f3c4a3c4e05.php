                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="customer_id_hidden" value="<?php echo e($lims_quotation_data->lead_id); ?>" />
                                            <input type="hidden" name="lead_id" value="<?php echo e($lead->id); ?>" />
                                            <?php
                                                $deposit = 0;
                                            ?>
                                            <div class="">
                                                <h4 class="">Lead Name : <?php echo e($lead->name ?? ''); ?> Company : <?php echo e($lead->company ?? ''); ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="sale_note" ><?php echo e($lims_quotation_data->note); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/quotation/create_sale.blade.php ENDPATH**/ ?>