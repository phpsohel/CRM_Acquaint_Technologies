                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <?php if(!empty($quotation->document)): ?>
                                <?php
                                $filepath = ('public/quotation/documents/').$quotation->document;
                                 ?>

                                <li>
                                    <a class="btn btn-link" target="_blank" href="<?php echo e(asset($filepath ?? '')); ?>"><i class="fa fa-shopping-basket" ></i> <?php echo e(trans('View Attachment')); ?></a></button>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/quotation/index.blade.php ENDPATH**/ ?>