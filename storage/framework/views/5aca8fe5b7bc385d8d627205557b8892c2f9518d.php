    ...
    <section class="forms">
        <div class="container-fluid">
            <div class="card">
                ...
                <?php echo Form::open(['route' => 'report.lead_employee', 'method' => 'post']); ?>
                ...
                <div class="row mb-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                ...
                                <select id="lead_cat_id" name="lead_cat_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" >
                                    ...
                                    <?php $__currentLoopData = $lims_lead_cat_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="d-tc">
                                <input type="hidden" name="thana_id_hidden" value="<?php echo e($thana_id); ?>" />
            ...
            <table id="report-table" class="table table-hover">
                ...
                <?php $__currentLoopData = $lims_lead_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id="<?php echo e($lead->id); ?>">
                        ...
                        <td><?php echo e($lead->thana->name ?? ''); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/report/lead_employee_report.blade.php ENDPATH**/ ?>