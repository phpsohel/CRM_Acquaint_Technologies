    ...
    <section>
        <?php if(in_array("employees-add", $all_permission)): ?>
            <div class="container-fluid">
                <a href="<?php echo e(route('remainder.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i>Add Reminder </a>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\somporko\resources\views/remainder/index.blade.php ENDPATH**/ ?>