    ...
    function saleDetails(sale){
        ...
        $.get('sales/product_sale/' + sale[13], function(data){
            ...
            if(sale[28]) {
                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=6><strong style="float:right;"><?php echo e(trans("file.Coupon Discount")); ?> ['+sale[28]+']:</strong></td>';
                cols += '<td>' + sale[29] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
            }
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong style="float:right;"><?php echo e(trans("file.Paid Amount")); ?>:</strong></td>';
            cols += '<td>' + sale[22] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong style="float:right;"><?php echo e(trans("file.Due")); ?>:</strong></td>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/sale/index.blade.php ENDPATH**/ ?>