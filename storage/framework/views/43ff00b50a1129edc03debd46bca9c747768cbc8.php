    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                if(data[12] < data[13])
                    alert("This Product is Shortage of Stock and will be out of stock soon. Please Reorder Again.");
            }
        }
    });
}
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crm\resources\views/sale/create.blade.php ENDPATH**/ ?>