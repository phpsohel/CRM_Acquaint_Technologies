    ...
    <section>
        <?php if(in_array("lead_category-add", $all_permission)): ?>
            <div class="container-fluid">
                <a href="<?php echo e(route('lead_category.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i>Add Lead Category</a>
            </div>
        <?php endif; ?>
        <div class="table-responsive">
            <table id="lead_status-table" class="table">
                ...
                <tbody>
                <?php $__currentLoopData = $lims_lead_category_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$lead_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id="<?php echo e($lead_status->id); ?>">
                        <td><?php echo e($key); ?></td>
                        <td><?php echo e($lead_status->lead_cat_name); ?></td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <?php if(in_array("lead_category-edit", $all_permission)): ?>
                                        <li>
                                            <button type="button" data-id="<?php echo e($lead_status->id); ?>" data-lead_cat_name="<?php echo e($lead_status->lead_cat_name); ?>" data-description="<?php echo e($lead_status->description); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button>
                                        </li>
                                    <?php endif; ?>
                                    <li class="divider"></li>
                                    <?php if(in_array("lead_category-delete", $all_permission)): ?>
                                        <li>
                                            <a href="<?php echo e(route('lead_category.destroy', $lead_status->id)); ?>" class="btn btn-link" onclick="return confirmDelete()"><i class="dripicons-trash"></i> <?php echo e(trans('file.delete')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php echo Form::open(['route' => ['lead_category.update', 1], 'method' => 'put', 'files' => true]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/lead_category/index.blade.php ENDPATH**/ ?>