                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php echo Form::open(['route' => 'remainder.new_store', 'method' => 'post', 'files' => true]); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select  required  name="lead_id" class="form-control"  >
                                            <?php $__currentLoopData = $lims_lead_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option  value="<?php echo e($reminder->lead_id); ?>"><?php echo e($reminder->lead->name); ?> ( <?php echo e($reminder->lead->company); ?> )</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="user_id" class="form-control">
                                            <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option selected value="<?php echo e($reminder->user_id); ?>"><?php echo e($reminder->user->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/remainder/create_new.blade.php ENDPATH**/ ?>