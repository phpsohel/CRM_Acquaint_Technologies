...
<style>
    .side-navbar {
    background-color: #b5bba442;
    }
    .table thead {
        background-color: #128b9f;
        color: #fff;
    }

    .table thead {
    background-color: #00ba8154;
    color: #000;
    }
    tbody {
    background: #f0814d0a;
...
/* Button */
    /* button.btn.btn-default.btn-xs.dropdown-toggle, button.btn.btn-default.btn-sm.dropdown-toggle{
        background: #0081c354;
        color: #000;
    } */
    button.btn.btn-default.btn-xs.dropdown-toggle, button.btn.btn-default.btn-sm.dropdown-toggle {
                ...
                <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document-remove"></i><span><?php echo e(trans('file.Reports')); ?></span></a>
                    <ul id="report" class="collapse list-unstyled ">
                        ...
                        <li id="lead_employee-report-menu">
                            <a id="lead_employee-report-link" href="<?php echo e(route('report.getlead_employee')); ?>">Lead Category Report</a>
                        </li>

                        <li id="lead_source-report-menu">
                            <a id="lead_source-report-link" href="<?php echo e(route('report.getlead_source')); ?>">Lead source Report</a>
                        </li>

                        <li id="lead_status-report-menu">
                            <a id="lead_status-report-link" href="<?php echo e(route('report.getlead_status')); ?>">Lead Status Report</a>
                        </li>


                        <li id="lead_reminder-report-menu">
                            <a id="lead_reminder-report-link" href="<?php echo e(route('report.getlead_reminder_report')); ?>">Lead Reminder Report</a>
                        </li>
                        ...
                        <li id="sale-report-menu">
                            <a id="sale-report-link" href="<?php echo e(route('report.getsale')); ?>"><?php echo e(trans('file.Sale Report')); ?></a>
                        </li>
                        <?php endif; ?>

                        <?php if($payment_report_active): ?>
                        <li id="payment-report-menu">
                            <a id="payment-report-link" href="<?php echo e(route('report.getpaymentByDate')); ?>"><?php echo e(trans('file.Payment Report')); ?></a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li id="due-report-menu">
                            <a id="due-report-link" href="<?php echo e(route('report.getdueByDate')); ?>"><?php echo e(trans('file.Due Report')); ?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </li>
...
//                        ['role_id', $role->id] ])->first();
              ...
              ?>
                ...
                <li id="unit-menu"><a href="<?php echo e(route('thana.index')); ?>">Thana</a></li>
                <?php endif; ?>
            ...
            <div class="container-fluid">
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <span class="brand-big" style="left:12%;"><?php if($general_setting->site_logo): ?><img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="150">&nbsp;&nbsp;<?php endif; ?><a href="<?php echo e(url('/')); ?>">
                            <h1 class="d-inline" style="display:none !important;"><?php echo e($general_setting->site_title); ?></h1>
                        </a></span>
...
<?php /**PATH C:\laragon\www\crm\resources\views/layout/main.blade.php ENDPATH**/ ?>