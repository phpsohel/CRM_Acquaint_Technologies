    ...
    <section>
        <?php if(in_array("lead_source-add", $all_permission)): ?>
            <div class="container-fluid">
                <a href="<?php echo e(route('lead_source.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i>Add Lead Source</a>
            </div>
        <?php endif; ?>
        <div class="table-responsive">
            <table id="lead_status-table" class="table">
                ...
                <tbody>
                <?php $__currentLoopData = $lims_lead_source_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$lead_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id="<?php echo e($lead_status->id); ?>">
                        <td><?php echo e($key); ?></td>
                        <td><?php echo e($lead_status->source_name); ?></td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <?php if(in_array("lead_source-edit", $all_permission)): ?>
                                        <li>
                                            <button type="button" data-id="<?php echo e($lead_status->id); ?>" data-source_name="<?php echo e($lead_status->source_name); ?>" data-description="<?php echo e($lead_status->description); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button>
                                        </li>
                                    <?php endif; ?>
                                    <li class="divider"></li>
                                    <?php if(in_array("lead_source-delete", $all_permission)): ?>
                                        <li>
                                            <a href="<?php echo e(route('lead_source.destroy', $lead_status->id)); ?>" class="btn btn-link" onclick="return confirmDelete()"><i class="dripicons-trash"></i> <?php echo e(trans('file.delete')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title">\Update Lead Source</h5>
                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                </div>
                <div class="modal-body">
                    <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    <?php echo Form::open(['route' => ['lead_source.update', 1], 'method' => 'put', 'files' => true]); ?>
...
$('.edit-btn').on('click', function() {
    ...
    $("#editModal input[name='source_name']").val( $(this).data('source_name') );
            ...
            action: function ( e, dt, node, config ) {
                if(user_verified == '1') {
                    ...
                    if(lead_status_id.length && confirm("Are you sure want to delete?")) {
                        $.ajax({
                            type:'POST',
                            url:'lead_source/deletebyselection',
                            data:{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/lead_source/index.blade.php ENDPATH**/ ?>