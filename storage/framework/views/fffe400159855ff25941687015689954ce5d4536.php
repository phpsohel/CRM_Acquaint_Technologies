                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="type" required class="form-control selectpicker" id="type">
                                                ...
                                                <option value="digital">Service</option>
                                            </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="qty" class="form-control" value="<?php echo e($lims_product_data->qty); ?>">
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="<?php echo e(url('public/images/product', $image)); ?>" height="60" width="60">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/product/edit.blade.php ENDPATH**/ ?>