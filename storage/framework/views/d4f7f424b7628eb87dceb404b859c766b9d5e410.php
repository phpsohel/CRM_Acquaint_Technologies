...
<script type="text/javascript" src="<?php echo e(asset('public/js/dataTables.fixedHeader.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/js/dataTables.responsive.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/js/responsive.bootstrap.min.js')); ?>"></script> <?php /**PATH C:\laragon\www\crm\resources\views/layout/all_data_table_js.blade.php ENDPATH**/ ?>