            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Update Quotation')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => ['quotations.update', $lims_quotation_data->id], 'method' => 'put', 'files' => true, 'id' => 'payment-form']); ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                	<div class="col-md-4">
                                        <div class="form-group">
                                            <label>Contact *</label>
                                            <input type="hidden" name="lead_id_hidden" value="<?php echo e($lims_quotation_data->lead_id); ?>" />
                                            <select required id="lead_id" name="lead_id" class="form-control">
                                                ...
                                                <option  value="<?php echo e($lead->id); ?>"><?php echo e($lead->name . ' (' . $lead->company . ')'); ?></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Stage *</label>
                                            <input type="hidden" name="stage_hidden" value="<?php echo e($lims_quotation_data->stage); ?>">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
                                                        ...
                                                        $customer = DB::table('leads')->find($lims_quotation_data->lead_id);
...
$('select[name="lead_id"]').val($('input[name="lead_id_hidden"]').val());
...
$('select[name="lead_id"]').on('change', function() {
    var id = $(this).val();
    // $.get('../getcustomergroup/' + id, function(data) {
    //     customer_group_rate = (data / 100);
    // });

    $.get('../get_product/' + id, function(data) {
        lims_product_array = [];
        product_code  = data[0];
        product_name  = data[1];
        product_type  = data[2];
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/acquqkkb/public_html/atechcrm/resources/views/quotation/edit.blade.php ENDPATH**/ ?>